...
const IndexPage: React.FC<Props> = props => {
  return (
    <Layout title='利用規約 | Kanon Code' currentUser={props.currentUser}>
      <Container maxWidth='md'>
        <Box my={10} pb={5} component='section'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>未成年による利用</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>ログイン情報の管理</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>コンテンツのご利用</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>遅延損害金</StyledBoxTitle>
            <StyledBoxText component='p'>
              当社に対する金銭債務の支払を遅滞したユーザーは、当社に対し、年14.6％の割合による遅延損害金を支払うものとします。
            </StyledBoxText>
          </StyledBoxBlock>
          <StyledBoxBlock>
            <StyledBoxTitle>ユーザーの投稿</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>禁止事項</StyledBoxTitle>
            <StyledBoxText component='p'>
              当社に対する金銭債務の支払を遅滞したユーザーは、当社に対し、年14.6％の割合による遅延損害金を支払うものとします。
            </StyledBoxText>
            <StyledUl>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>反社会的勢力の排除</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>利用制限</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>本サービスの提供の停止</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            ...
            <StyledBoxText component='p'>
              ...
              当社は、本サービスに関してユーザーが被った損害につき、当該損害が発生した月内にユーザーが当社に支払った利用料金を超えて賠償する責任を負わないものとしま
            </StyledBoxText>
          </StyledBoxBlock>
          <StyledBoxBlock>
            <StyledBoxTitle>サービス内容の変更</StyledBoxTitle>
            <StyledBoxText component='p'>
              当社は、ユーザーに通知することなく、本サービスの内容を変更したり、本サービスの提供を中止、終了することができるものとします。当社は、これによってユーザーに生じた損害について一切の責任を負いません。{' '}
            </StyledBoxText>
          </StyledBoxBlock>
          <StyledBoxBlock>
            <StyledBoxTitle>利用規約の変更</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>個人情報の取り扱い</StyledBoxTitle>
            <StyledBoxText component='p'>
              本サービスの利用によって取得するユーザーの個人情報については、当社のプライバシーポリシーに従い適切に取り扱うものとします。{' '}
            </StyledBoxText>
          </StyledBoxBlock>
          <StyledBoxBlock>
            <StyledBoxTitle>通知または連絡</StyledBoxTitle>
            <StyledBoxText component='p'>
              ユーザーと当社との間の通知または連絡は、当社の定める方法によって行うものとします。当社は、ユーザーから、当社が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
            </StyledBoxText>
          </StyledBoxBlock>
          <StyledBoxBlock>
            <StyledBoxTitle>権利義務の譲渡</StyledBoxTitle>
            <StyledBoxText component='p'>
              ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
            </StyledBoxText>
          </StyledBoxBlock>
          <StyledBoxBlock>
            <StyledBoxTitle>事業譲渡</StyledBoxTitle>
            <StyledBoxText component='p'>
          ...
          <StyledBoxBlock>
            <StyledBoxTitle>適用関係</StyledBoxTitle>
            <StyledBoxText component='p'>
